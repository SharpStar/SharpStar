...
namespace SharpStar.Lib.Packets.Handlers
{
    ...
    {
        public override Task Handle(OpenContainerPacket packet, SharpStarClient client)
        {
        ...
        public override Task HandleAfter(OpenContainerPacket packet, SharpStarClient client)
        {
